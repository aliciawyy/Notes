...
- Titres distribuant des coupons fixes
- Instruments distribuant aux instants $t=1,2,...,N$ des intérêts qui sont fonction de la valeur $I(t)$ d'un indice de référence.

On distingue deux catégories d'instruments à taux flottant

1. Des actifs classiques (bons, obligations...) si ce n'est qu'ils distribuent un coupon flotant (*Floating Rate Notes*).
